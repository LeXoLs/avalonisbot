...
exports.run = async (client, message, args) => {
  ...
  if (!rol) {
    return message.channel.send(`<a:x:660744451760586762> Otorol olarak ayarlamak istediğin rolü etiketlemelisin.`)
    }
  ...
  db.set(`rolK_${message.guild.id}` ,rolk.name)
    ...
    message.channel.send(`<a:white_check_mark:660744428025282600> Otorol \`${rol.name}\`, otorol kanalı #${rolk.name} olarak ayarlandı.`)
