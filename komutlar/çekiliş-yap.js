...
var filter = m => m.author.id === message.author.id;
      ...
      message.channel.send(`:eight_pointed_black_star:| **Çekilişin yapılacağı kanalın adını yaz (Sakın # Koyma Yoksa Olmaz. Sadece Kanal Adını Yaz)**`).then(msg => {
      message.channel.awaitMessages(filter, {
        ...
        msg.edit(':eight_pointed_black_star:| **Çekilişin süresini belirle (1s (saniye), 1m (dakika ), 1h (saat ), 1d (gün),1w (hafta))**').then(msg => {
          message.channel.awaitMessages(filter, {
            max: 1,
            time: 20000,
            errors: ['time']
            ...
            msg.edit(':eight_pointed_black_star:| **Ödülü belirle**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setFooter(message.author.username + " (Alfa Bot | Çekiliş Sistemi)", message.author.avatarURL);
                  message.guild.channels.find("name" , room).send(' :heavy_check_mark: **ÇEKİLİŞ BAŞLADI** :heavy_check_mark:' , {embed: giveEmbed}).then(m => {
                     ...
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor("#f558c9")
            .setFooter("(Tempestas | Çekiliş Sistemi)")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("Ödülünü yetkililere ulaşarak alabilirsin!").setFooter("(Alfa Bot | Çekiliş Sistemi)")
